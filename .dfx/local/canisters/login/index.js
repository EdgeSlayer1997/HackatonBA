...
export const canisterId = process.env.CANISTER_ID_LOGIN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./login.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the login canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./login.did.js")._SERVICE>}
 */
