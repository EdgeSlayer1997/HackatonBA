...
import { idlFactory } from './services.did.js';
export { idlFactory } from './services.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SERVICES;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./services.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the services canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./services.did.js")._SERVICE>}
 */
export const services = createActor(canisterId);
