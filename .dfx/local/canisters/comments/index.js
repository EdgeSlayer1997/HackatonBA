...
import { idlFactory } from './comments.did.js';
export { idlFactory } from './comments.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMMENTS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./comments.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the comments canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./comments.did.js")._SERVICE>}
 */
export const comments = createActor(canisterId);
