...
import { idlFactory } from './HackatonBA_frontend.did.js';
export { idlFactory } from './HackatonBA_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HACKATONBA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./HackatonBA_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the HackatonBA_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./HackatonBA_frontend.did.js")._SERVICE>}
 */
export const HackatonBA_frontend = createActor(canisterId);
