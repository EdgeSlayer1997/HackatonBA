...
import { idlFactory } from './register.did.js';
export { idlFactory } from './register.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REGISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./register.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the register canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./register.did.js")._SERVICE>}
 */
export const register = createActor(canisterId);
