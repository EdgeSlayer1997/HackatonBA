...
import { comments } from 'declarations/comments';
...
function Comments() {
  ...
  const validate = () => {
    ...
    if (!pregunta7Regex.test(form.pregunta7)) {
      newErrors.pregunta7 = 'Debe contener entre 5 y 200 caracteres, solo letras, números y espacios';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      try {
        await comments.crearComentario(
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <textarea id="pregunta7" name="pregunta7" value={form.pregunta7} onChange={handleChange} minLength="5" maxLength="200" required></textarea>
